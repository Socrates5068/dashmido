<p x-data="{ hover : false }"
    ...
    <svg :class="hover ? 'w-12 h-12 opacity-100': 'w-10 h-10 opacity-60'" 
        @click="hover = !hover"
        class="hover:opacity-100 hover:w-12 hover:h-12 inline-block leading-tight cursor-pointer" version="1.1" id="Layer_1"
        type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false"
        aria-controls="collapseExample" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
