<div>
                    ...
                    <table class="table table-report sm:mt-2">
                        ...
                        <tbody>
                            @foreach ($tickets as $ticket)
                                <tr class="intro-x">
                                    <td>
                                        <a href="" class="font-medium whitespace-nowrap">{{ $ticket->time }}</a>
                                    </td>
                                    <td>
                                        {{-- <b class="font-medium whitespace-nowrap">{{ substr($depa->description, 0, 20) . '...' }}</b> --}}
                                        <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ $ticket->name }}</div>
                                    </td>
    ...
    @else
        <div wire class="flex items-center alert alert-dark show mt-6 w-full max-w-lg mx-auto" role="alert">
            ...
            </svg> <p class="ml-3"> Seleccione una especialidad </p>
        </div>
    @endif
</div>
