                ...
                <div class="box">
                    <div class="flex flex-col items-center p-5 lg:flex-row">
                        ...
                        <div class="flex mt-4 lg:mt-0">
                            ...
                            <button wire:click="editUser('{{ $user->id }}')" @click="editUser = true" class="px-2 py-1 btn btn-outline-secondary">Editar</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-10 -mt-4 modal-body">
                        ...
                        <div class="gap-4 md:grid md:grid-cols-2">
                            ...
                            <div class="mt-3">
                                ...
                                <select wire:model="user.sex" data-placeholder="Seleccione un sexo" class="w-full form-control" id="sex">
                        ...
                        <button class="mt-10 mr-2 shadow-md btn btn-danger" @click="modalSlide = false, Livewire.emit('resetVariables')">Cerrar</button>

                        <button wire:click="saveUser" @click="Livewire.on('save', () => {modalSlide = false; } )" class="mr-2 shadow-md btn btn-primary">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
