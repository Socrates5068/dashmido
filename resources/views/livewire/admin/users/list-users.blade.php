        ...
        <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">
            ...
            <div class="dropdown">
                <button class="px-2 dropdown-toggle btn box" aria-expanded="false" data-tw-toggle="dropdown">
                    <span class="flex items-center justify-center w-5 h-5"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="col-span-12 intro-y md:col-span-6">
                <div class="box">
                    <div class="absolute right-0 p-1 -mt-6">
                        <svg  wire:click="deleteUser({{ $user->id }})" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-red-600 cursor-pointer"
