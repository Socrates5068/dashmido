                ...
                <div class="col-span-12 xl:col-span-8 mt-6">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="report-maps mt-5 bg-slate-200 rounded-md" data-center="-6.2425342, 106.8626478"
                            data-sources="/midone/dist/json/location.json"></div>
                    </div>
                </div>
                <!-- END: Official Store -->
                    ...
                    <div class="mt-5">
                        ...
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                    <img alt="Rubick Tailwind HTML Admin Template"
                                        src="midone/dist/images/profile-15.jpg">
                                </div>
                                <div class="ml-4 mr-auto">
                    ...
                    <div class="intro-y block sm:flex items-center h-10">
                        ...
                        <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                            <button class="btn box flex items-center text-slate-600 dark:text-slate-300"> <i
                                    data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> Export
                                to Excel </button>
                            <button class="ml-3 btn box flex items-center text-slate-600 dark:text-slate-300">
                                <i data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> Export to
                                PDF </button>
                        </div>
                    </div>
                                        ...
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                    ...
                                                    src="midone/dist/images/preview-13.jpg"
                                            ...
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                    class="tooltip rounded-full"
                                                    src="midone/dist/images/preview-11.jpg"
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                    class="tooltip rounded-full"
                                                    src="midone/dist/images/preview-6.jpg"
                                                    title="Uploaded at 31 May 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                    class="tooltip rounded-full"
                                                    src="midone/dist/images/preview-9.jpg"
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                    class="tooltip rounded-full"
                                                    src="midone/dist/images/preview-10.jpg"
                                                    title="Uploaded at 26 July 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                    class="tooltip rounded-full"
                                                    src="midone/dist/images/preview-14.jpg"
                        ...
                        <div class="mt-5">
                            ...
                            <div class="intro-x">
                                <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Rubick Tailwind HTML Admin Template"
                                            src="midone/dist/images/profile-11.jpg">
                                    </div>
                                    <div class="ml-4 mr-auto">
                        ...
                        <div
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Rubick Tailwind HTML Admin Template"
                                            src="midone/dist/images/profile-12.jpg">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
                                    ...
                                    <div class="text-slate-500">
                                        ...
                                        <div class="flex mt-2">
                                            ...
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in"
                                                ...
                                                <img alt="Rubick Tailwind HTML Admin Template"
                                                    class="rounded-md border border-white"
                                                    src="midone/dist/images/preview-7.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Rubick Tailwind HTML Admin Template"
                                            src="midone/dist/images/profile-9.jpg">
                                    </div>
                                </div>
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    <div class="flex items-center">
