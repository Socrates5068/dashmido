                    ...
                    <tbody>
                        @foreach ($cards as $card)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    {{Person::find($card->doctor_id)->name}}
                                    {{Person::find($card->doctor_id)->f_last_name}}
                                </td>
                                <td class="px-6 py-4">
                                    {{Department::find($card->department_id)->name}}
                                </td>
                                {{-- <td class="px-6 py-4 text-right">
                                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Imprimir</a>
                                </td> --}}
                            </tr>
                        @endforeach
                    </tbody>
